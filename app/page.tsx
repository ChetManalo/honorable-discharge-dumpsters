...
export default function Home() {
  return (
    <main>
      <section className="flex flex-col items-end justify-end p-6 md:p-12 text-offWhite bg-[url('/images/hero.webp')] bg-no-repeat bg-cover w-full md:w-11/12 max-w-[1700px] max-h-[500px] md:my-8 md:rounded-md mx-auto aspect-video">
