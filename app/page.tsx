    ...
    <main>
      ...
      <section className="text-center py-14 px-4 bg-blueGradient text-offWhite">
        ...
        <div className="flex flex-col md:flex-row md:justify-center items-center gap-4 mt-6">
          <Card yards={13} price={300} desc="Perfect for small to mid-sized projects, such as home cleanouts, minor remodeling, or yard waste removal." image="/images/13Yard.jpg" />
        </div>
